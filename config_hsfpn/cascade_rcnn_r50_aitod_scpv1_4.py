# HS-FPN + SCPV1-4 soft object-mask guided deformable semantic attention.
#
# V1-4 keeps V1-3's deformable semantic attention and replaces hard bbox gate
# supervision with a GT-box-derived soft object mask.
...
custom_imports = dict(
    imports=[
        ...
        'mmdet.models',
        'mmdet.models.necks.hs_scpv1_4_fpn',
        'mmdet.models.detectors.scp_cascade_rcnn_v1_4',
...
work_dir = '/mnt/e/mmdet5090/work_dirs/cascade_rcnn_r50_aitod_scpv1_4_b1_k150_epoch12'

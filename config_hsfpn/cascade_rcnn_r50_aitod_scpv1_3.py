# HS-FPN + SCPV1-3 foreground-gated deformable semantic attention config.
#
# This config mirrors SCPV1-1 and only swaps the neck implementation.  The
# detector/loss wrapper is reused because V1-3 keeps the same semantic logits
...
custom_imports = dict(
    imports=[
        ...
        'mmdet.models',
        'mmdet.models.necks.hs_scpv1_3_fpn',
...
work_dir = '/mnt/e/mmdet5090/work_dirs/cascade_rcnn_r50_aitod_scpv1_3_b1_k150_epoch12'

# HS-SCPV1-5 dense semantic ablation + RFLA for VisDrone2019-DET.
...
_base_ = ['./cascade_rcnn_r50_visdrone_scpv1_5_dense.py']
...
work_dir = (
    ...
    'cascade_rcnn_r50_visdrone_scpv1_5_dense_rfla_b2_k150_epoch12')

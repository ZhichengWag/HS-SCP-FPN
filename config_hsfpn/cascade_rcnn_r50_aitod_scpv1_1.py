# HS-FPN + SCPV1-1 foreground-aware query gate config.
#
...
custom_imports = dict(
    imports=[
        ...
        'mmdet.models',
        'mmdet.models.necks.hs_scpv1_1_fpn',
...
work_dir = '/mnt/e/mmdet5090/work_dirs/cascade_rcnn_r50_aitod_scpv1_1_b1_k150_epoch12'

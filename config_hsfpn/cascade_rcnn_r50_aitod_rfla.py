...
# NOTE: The old RFLA config referenced RFGenerator, HieAssigner and
# BboxDistanceMetric, which are not present in this MMDetection 3.x checkout.
# They have been reset to standard AnchorGenerator + MaxIoUAssigner so the
# config can run. Port those modules to restore the original RFLA behavior.

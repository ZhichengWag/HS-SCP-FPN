# FCOS R50 + HS-SCPV1.5-FPN for AI-TOD.
...
pseudo_label_root = os.getenv('SCP_PSEUDO_LABEL_ROOT',
...
work_dir = './work_dirs/fcos_r50_aitod_scpv1_5_b1_k150_t10000_gate0.1_epoch12'
